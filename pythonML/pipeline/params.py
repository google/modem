...
#
# CSV_COLUMN_MAP is a dictionary that maps BigQuery column names to corresponding
#    Data Import schema headers.
# To ensure that the Data Import CSV is correctly created, you need to provide the CSV_COLUMN_MAP.
# E.g., If your BigQuery table has following schema ->
# clientId, clientName, feature1, feature2, feature3,
...
# your CSV_COLUMN_MAP will look as follows-  (predicted is always reserved for model output) 
